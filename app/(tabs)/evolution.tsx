...
const s = StyleSheet.create({
  ...
  // View Selector
  viewSelector: { flexDirection: 'row', marginHorizontal: 10, marginBottom: 6, backgroundColor: '#0D1117', borderRadius: 8, borderWidth: 1, borderColor: '#1A3A2A', padding: 3, gap: 3 },
  viewSelectorBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 7, borderRadius: 6, gap: 5 },
  ...
  // Compare Selector
  compareSelector: { flexDirection: 'row', marginHorizontal: 10, marginBottom: 6, gap: 4, flexWrap: 'wrap' },
  compareSelectorBtn: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 6, backgroundColor: '#0D1117', borderWidth: 1, borderColor: '#1A3A2A' },
  ...
  cardTitle: { fontSize: 11, fontWeight: '700', letterSpacing: 1, color: '#00E5FF', fontFamily: MONO },

  // Chart
  chartSubtitle: { fontSize: 10, fontWeight: '600', letterSpacing: 0.5, color: '#6B8A7A', marginBottom: 8, fontFamily: MONO },
  chartContainer: { flexDirection: 'row', alignItems: 'flex-end', gap: 6 },
  chartYAxis: { justifyContent: 'space-between', height: 160, paddingBottom: 4 },
  ...
  chartBarValue: { fontSize: 12, fontWeight: '800', fontFamily: MONO },
  chartBarLabel: { fontSize: 9, fontWeight: '600', marginTop: 4, fontFamily: MONO },

  // Stacked
  stackedRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 5, gap: 6 },
  ...
  // GUT Line
  gutLineContainer: { flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', paddingVertical: 10 },
  gutLineCol: { alignItems: 'center', flex: 1 },
  gutLineValue: { fontSize: 16, fontWeight: '800', fontFamily: MONO },
  ...
  // Stats Grid
  statsGrid: { flexDirection: 'column', gap: 8, marginTop: 4 },
  statsGridDesktop: { flexDirection: 'row' },
  statInner: { alignItems: 'center', paddingVertical: 10, gap: 4 },
  statIconBg: { width: 30, height: 30, borderRadius: 15, alignItems: 'center', justifyContent: 'center' },
  ...
  // Table (Desktop)
  tableHeader: { flexDirection: 'row', paddingHorizontal: 8, paddingVertical: 7, backgroundColor: '#0A0E14', borderRadius: 6, marginBottom: 3, borderWidth: 1, borderColor: '#1A3A2A' },
  thCell: { fontWeight: '700', fontSize: 9, color: '#6B8A7A', fontFamily: MONO, letterSpacing: 0.3 },
  thId: { width: 50 },
  thDesc: { flex: 1, minWidth: 180 },
  thVal: { width: 70, textAlign: 'center' as any },
  thStatus: { width: 90, textAlign: 'center' as any },
  tableRow: { flexDirection: 'row', paddingHorizontal: 8, paddingVertical: 7, borderRadius: 4, borderBottomWidth: 1, borderBottomColor: '#1A3A2A20' },
  tdCell: { justifyContent: 'center' },
  tdId: { fontSize: 11, fontWeight: '700', color: '#00E5FF', fontFamily: MONO },
  tdDesc: { fontSize: 10, color: '#9BA1A6', lineHeight: 14 },
  scoreBox: { paddingHorizontal: 6, paddingVertical: 3, borderRadius: 4, borderWidth: 1, alignSelf: 'center' },
  scoreBoxText: { fontSize: 11, fontWeight: '800', fontFamily: MONO, textAlign: 'center' },
  naText: { fontSize: 11, color: '#6B8A7A', textAlign: 'center', fontFamily: MONO },
  gutText: { fontSize: 11, fontWeight: '600', color: '#9BA1A6', textAlign: 'center', fontFamily: MONO },
  statusBadge: { paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, borderWidth: 1, alignSelf: 'center' },
  statusText: { fontSize: 8, fontWeight: '700', fontFamily: MONO },
  ...
  // Matrix
  matrixContainer: { marginBottom: 12 },
  matrixHeaderRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 8 },
  matrixBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 5, borderWidth: 1 },
  ...
  yAxisLabel: { justifyContent: 'center', alignItems: 'center', height: 220 },
  ...
  matrixCellText: { fontSize: 12, fontWeight: '800', fontFamily: MONO },
  xAxisLabel: { alignItems: 'center', marginTop: 4 },
  matrixGrid: { flexDirection: 'row', gap: 16, justifyContent: 'center' },
