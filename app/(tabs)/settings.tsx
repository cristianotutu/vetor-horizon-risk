...
const styles = StyleSheet.create({
  scrollContent: { flexGrow: 1, paddingHorizontal: 10, paddingBottom: 8 },
  scrollContentDesktop: { paddingHorizontal: 14 },
  ...
  card: { borderWidth: 1, borderRadius: 10, padding: 10, flex: 1, minWidth: 280 },
  cardHeaderRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 6 },
  cardIcon: { width: 30, height: 30, borderRadius: 7, justifyContent: 'center', alignItems: 'center' },
  cardTitle: { fontSize: 14, fontWeight: '700', flex: 1 },
  infoGrid: { gap: 0 },
  infoItem: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', paddingVertical: 7, borderBottomWidth: 0.5, borderBottomColor: '#E2E8F020' },
  infoLabel: { fontSize: 11, fontWeight: '500', flex: 1 },
  infoValue: { fontSize: 11, fontWeight: '600', flex: 2, textAlign: 'right' },
  methodDesc: { fontSize: 11, lineHeight: 16, marginBottom: 8 },
  stepsContainer: { gap: 6 },
  stepRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 8 },
  stepBadge: { width: 26, height: 26, borderRadius: 6, justifyContent: 'center', alignItems: 'center' },
  stepNumber: { fontSize: 12, fontWeight: '800' },
  stepContent: { flex: 1 },
  stepTitle: { fontSize: 12, fontWeight: '700' },
  stepDesc: { fontSize: 11, lineHeight: 15, marginTop: 2 },
  examplesContainer: { gap: 6 },
  exampleCard: { padding: 10, borderLeftWidth: 3, borderRadius: 8 },
  exampleLabel: { fontSize: 10, fontWeight: '700', letterSpacing: 0.3, marginBottom: 3 },
  exampleText: { fontSize: 12, lineHeight: 17, fontStyle: 'italic' },
  statsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  statBox: { flex: 1, minWidth: '40%', borderWidth: 1, borderRadius: 8, padding: 12, alignItems: 'center' },
  statBoxValue: { fontSize: 18, fontWeight: '800' },
  statBoxLabel: { fontSize: 11, marginTop: 3, textAlign: 'center' },
  consultantsList: { gap: 0 },
  consultantRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 8, borderBottomWidth: 0.5 },
  consultantAvatar: { width: 34, height: 34, borderRadius: 17, justifyContent: 'center', alignItems: 'center' },
  consultantInitial: { fontSize: 15, fontWeight: '700' },
  consultantName: { fontSize: 13, fontWeight: '600', flex: 1 },
  ...
  footerVersion: { fontSize: 11, marginTop: 3 },
  linkCard: { padding: 12, borderRadius: 8, borderWidth: 1, alignItems: 'center' as const },
  linkText: { fontSize: 13, fontWeight: '600' as const, textDecorationLine: 'underline' as const },
});
