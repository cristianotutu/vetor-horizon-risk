...
const s = StyleSheet.create({
  ...
  headerSubtitle: { fontSize: 11, marginTop: 1, letterSpacing: 0.5 },
  section: { marginBottom: 4 },
  kpiGridDesktop: { flexDirection: 'row', gap: 8 },
  kpiGridMobile: { gap: 6 },
  gaugeCard: { flex: 1, borderRadius: 8, borderWidth: 1, padding: 8 },
  gaugeLabel: { fontSize: 9, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5, fontFamily: 'monospace' },
  gaugeValue: { fontSize: 22, fontWeight: '800', marginTop: 1, fontFamily: 'monospace' },
  gaugeUnit: { fontSize: 14, fontWeight: '600' },
  gaugeBarBg: { height: 3, borderRadius: 2, marginTop: 6 },
  gaugeBarFill: { height: 3, borderRadius: 2 },
  gaugeSubtitle: { fontSize: 9, marginTop: 3, fontFamily: 'monospace' },
  card: { borderRadius: 8, borderWidth: 1, padding: 10 },
  cardHeader: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 6 },
  cardTitle: { fontSize: 12, fontWeight: '700', flex: 1, letterSpacing: 0.3 },
  heatRow: { marginBottom: 8 },
  heatLabelRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 3 },
  heatLabel: { fontSize: 11, fontWeight: '500', flex: 1 },
  heatCount: { fontSize: 11, fontWeight: '700', minWidth: 18, textAlign: 'right' },
  heatBadge: { paddingHorizontal: 6, paddingVertical: 2, borderRadius: 3 },
  heatBadgeText: { fontSize: 9, fontWeight: '700' },
  heatBarBg: { height: 5, borderRadius: 3 },
  heatBarFill: { height: 5, borderRadius: 3 },
  treatmentGrid: { gap: 6 },
  treatmentItem: { flexDirection: 'row', alignItems: 'center', gap: 8, padding: 8, borderRadius: 6, borderWidth: 1 },
  treatmentDot: { width: 8, height: 8, borderRadius: 4 },
  treatmentLabel: { fontSize: 11, fontWeight: '600' },
  treatmentPct: { fontSize: 9, marginTop: 1 },
  treatmentNum: { fontSize: 16, fontWeight: '800' },
  tprmBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 4 },
  tprmBadgeText: { fontSize: 9, fontWeight: '700', letterSpacing: 0.3 },
  tprmStatsRow: { flexDirection: 'row', gap: 8, marginBottom: 10 },
  tprmStatsCol: { gap: 6, marginBottom: 10 },
  tprmStatCard: { flex: 1, borderRadius: 6, borderWidth: 1, padding: 10, alignItems: 'center' },
  tprmStatLabel: { fontSize: 9, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.3 },
  tprmStatValue: { fontSize: 18, fontWeight: '800', marginTop: 1 },
  tprmStatSub: { fontSize: 10, marginTop: 1 },
  tprmRiskRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 7, borderBottomWidth: 1 },
  tprmRiskId: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 4 },
  tprmRiskIdText: { fontSize: 11, fontWeight: '700' },
  tprmRiskDesc: { fontSize: 11, lineHeight: 15 },
  tprmRiskMeta: { fontSize: 9, marginTop: 1 },
  tprmRiskScore: { fontSize: 16, fontWeight: '800' },
  tprmRiskLevel: { fontSize: 9, fontWeight: '600' },
  top10Row: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 7, borderBottomWidth: 1 },
  top10Rank: { width: 30, height: 30, borderRadius: 5, alignItems: 'center', justifyContent: 'center' },
  top10RankText: { fontSize: 11, fontWeight: '800' },
  top10Id: { fontSize: 11, fontWeight: '700' },
  top10LevelBadge: { paddingHorizontal: 5, paddingVertical: 1, borderRadius: 3 },
  top10LevelText: { fontSize: 9, fontWeight: '600' },
  top10Desc: { fontSize: 11, lineHeight: 15, marginTop: 1 },
  top10BarBg: { height: 3, borderRadius: 2, marginTop: 3 },
  top10BarFill: { height: 3, borderRadius: 2 },
  top10Gut: { fontSize: 16, fontWeight: '800' },
  top10GutLabel: { fontSize: 8, fontWeight: '600' },
  respRow: { marginBottom: 8 },
  respLabelRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 3 },
  respLabel: { fontSize: 11, fontWeight: '500', flex: 1 },
  respCount: { fontSize: 12, fontWeight: '700' },
  levelBarContainer: { flexDirection: 'row', height: 22, borderRadius: 5, overflow: 'hidden', marginBottom: 8 },
  levelBarSegment: { justifyContent: 'center', alignItems: 'center' },
  levelBarText: { color: '#000', fontSize: 10, fontWeight: '800' },
  levelLegend: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
  legendItem: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  legendDot: { width: 7, height: 7, borderRadius: 4 },
  legendText: { fontSize: 10 },
  originCard: { borderRadius: 8, borderWidth: 1, padding: 10, alignItems: 'center' },
  originLabel: { fontSize: 10, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5 },
  originValue: { fontSize: 22, fontWeight: '800', marginTop: 1 },
  originPct: { fontSize: 12, fontWeight: '600', marginTop: 1 },
  originBar: { height: 3, borderRadius: 2, width: '100%', marginTop: 6 },
  originBarFill: { height: 3, borderRadius: 2 },
