    ...
    <ScreenContainer edges={["top", "bottom", "left", "right"]} className="flex-1">
      ...
      >
        ...
        <View style={[styles.header, { borderBottomColor: colors.border }]}>
          ...
          <Text style={[styles.headerTitle, { color: colors.foreground }]}>Novo Risco</Text>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
          ...
          {step === 1 && (
            <View className="px-5 gap-4">
              ...
              <View>
                <Text style={[styles.label, { color: colors.muted }]}>Consequência direta ou estimada</Text>
                <TextInput
                  style={[styles.textArea, { color: colors.foreground, backgroundColor: colors.surface, borderColor: colors.border }]}
          ...
          {step === 3 && (
            <View className="px-5 gap-4">
              <SliderField
                ...
                onChange={v => updateField('probabilidade', v)}
                colors={colors}
              />
              <SliderField
                label="Impacto"
                value={risk.impacto}
                onChange={v => updateField('impacto', v)}
                colors={colors}
              />
              <View style={[styles.calcBox, { backgroundColor: colors.surface, borderColor: colors.border }]}>
                ...
                <View style={styles.calcRow}>
                  <Text style={[styles.calcValue, { color: getRiskLevel(risk.riscoInerente).color }]}>
                    {risk.riscoInerente}
                  </Text>
                  <View style={[styles.badge, { backgroundColor: getRiskLevel(risk.riscoInerente).color + '20' }]}>
                    <Text style={[styles.badgeText, { color: getRiskLevel(risk.riscoInerente).color }]}>
                      {getRiskLevel(risk.riscoInerente).label}
                    </Text>
                  </View>
                </View>
              </View>
          ...
          {step === 4 && (
            <View className="px-5 gap-4">
              ...
              <SliderField
                label="Tendência (T)"
                value={risk.tendencia}
                onChange={v => updateField('tendencia', v)}
                colors={colors}
              />
              <View style={[styles.calcBox, { backgroundColor: colors.surface, borderColor: colors.border }]}>
                <Text style={[styles.calcLabel, { color: colors.muted }]}>GUT Score (G × U × T)</Text>
                <View style={styles.calcRow}>
                  <Text style={[styles.calcValue, { color: getGutLevel(risk.gutScore).color }]}>
                    {risk.gutScore}
                  </Text>
                  <View style={[styles.badge, { backgroundColor: getGutLevel(risk.gutScore).color + '20' }]}>
                    <Text style={[styles.badgeText, { color: getGutLevel(risk.gutScore).color }]}>
                      {getGutLevel(risk.gutScore).label}
                    </Text>
                  </View>
                </View>
              </View>
          ...
          {step === 5 && (
            <View className="px-5 gap-4">
              ...
              <View>
                <Text style={[styles.label, { color: colors.muted }]}>Controles Gerais do Tratamento</Text>
                <TextInput
                  style={[styles.textArea, { color: colors.foreground, backgroundColor: colors.surface, borderColor: colors.border }]}
              ...
              <View>
                <Text style={[styles.label, { color: colors.muted }]}>Responsável pelo Risco</Text>
                <TextInput
                  style={[styles.input, { color: colors.foreground, backgroundColor: colors.surface, borderColor: colors.border }]}
              ...
              <View>
                <Text style={[styles.label, { color: colors.muted }]}>Prazo para Tratamento</Text>
                <TextInput
                  style={[styles.input, { color: colors.foreground, backgroundColor: colors.surface, borderColor: colors.border }]}
              ...
              <View>
                <Text style={[styles.label, { color: colors.muted }]}>Key Risk Indicators (KRI)</Text>
                <TextInput
                  style={[styles.textArea, { color: colors.foreground, backgroundColor: colors.surface, borderColor: colors.border }]}
          ...
          {step === 6 && (
            <View className="px-5 gap-4">
              <SliderField
                label="Redução de Risco Pretendida"
                value={risk.reducaoPretendida}
                onChange={v => updateField('reducaoPretendida', v)}
                colors={colors}
              />
              <SliderField
                label="Risco Residual"
                value={risk.riscoResidual}
                onChange={v => updateField('riscoResidual', v)}
                colors={colors}
              />
              <View>
