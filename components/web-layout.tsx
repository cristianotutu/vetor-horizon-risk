...
const styles = StyleSheet.create({
  ...
  navList: { paddingHorizontal: 8, gap: 1, flex: 1 },
  navItem: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: 10,
  ...
  navLabel: { fontSize: 12, fontWeight: '500', letterSpacing: 0.3 },
  ...
  footerText: { fontSize: 9, textAlign: 'center', marginTop: 2, letterSpacing: 0.5 },
});
